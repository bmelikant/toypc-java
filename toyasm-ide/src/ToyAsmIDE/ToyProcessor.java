...
public class ToyProcessor implements Serializable {
	...
	public static final short NOP    = 0x60;	// implemented, onebyte
        public static final short HLT    = 0x10;	// implemented, onebyte
        public static final short CPUID  = 0x15;	// implemented, onebyte
	...
	public static final short JMPDI  = 0x46;
        public static final short IN     = 0x55;        // implemented, onebyte
	public static final short OUT    = 0x56;        // implemented, onebyte
	...
	public static final short IRET   = 0x46;	// implemented
        ...
        public static final short STO   = 0x01;		// implemented, math
	public static final short LOD   = 0x02;		// implemented, math
	public static final short ADD   = 0x03;		// implemented, math
	public static final short SUB   = 0x04;		// implemented, math
	public static final short MUL   = 0x05;		// implemented, math
	public static final short DIV   = 0x06;		// implemented, math
	public static final short MOD   = 0x07;		// implemented, math
	public static final short AND   = 0x11;		// implemented, math
	public static final short OR    = 0x12;		// implemented, math
	public static final short XOR   = 0x13;		// implemented, math
	public static final short CMP   = 0x14;		// implemented, math
	public static final short SHL   = 0x0A;		// implemented, math
	public static final short SHR   = 0x0B;		// implemented, math
        
	public static final short CALL  = 0x0E;		// implemented, branch
	public static final short JMP   = 0x0F;		// implemented, branch

	public static final short PSH   = 0x08;		// implemented, stack
	public static final short POP   = 0x09;		// implemented, stack
        
        public static final short INT   = 0x16;		// implemented, special
	...
	public static final short STFL = 0x23;          // implemented
	public static final short STFD = 0x24;          // implemented
	public static final short STFO = 0x25;          // implemented
	public static final short STFI = 0x26;          // implemented
	
	public static final short CLFZ = 0x27;          // implemented
	public static final short CLFA = 0x28;          // implemented
	public static final short CLFC = 0x29;          // implemented
	public static final short CLFE = 0x2A;          // implemented
	public static final short CLFG = 0x2B;          // implemented
	public static final short CLFL = 0x2C;          // implemented
	public static final short CLFD = 0x48;          // implemented
	public static final short CLFO = 0x49;          // implemented
	public static final short CLFI = 0x4A;          // implemented
	...
	public boolean processOpcode () {
		...
		if (opcode == NOP)
			return true;
                ...
                // HLT stops the processor
                    ...
                    if (debugMode)
                        System.out.println ("HLT opcode detected");
		...
		// instruction or you will be dumped to a random point in memory!!!
			...
			return true;
                ...
                // JMPDI instruction transfers execution to memory location stored in DI
                else if (opcode == JMPDI) {
                    
                    // set the IP register == to DI
                    setRegister (getRegister (constRegD), constRegIP);
                    return true;
                }
		...
		// if the opcode could not be processed, flag an invalid opcode and shut down
			...
			interrupt (ILLEGAL_INSTRUCTION);
                        ...
                        if (debugMode)
                            System.out.println ("Error: Illegal instruction detected: " + this.opcode);
